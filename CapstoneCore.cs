...
#if LIN
#if CSV4
        const string CapStoneNativeMod = "libcapstone.so.3";
#endif
#if CSV3
        const string CapStoneNativeMod = "libcapstone.so.4";
#endif
#endif
#if WIN
#if CSV4
        const string CapStoneNativeMod = "capstone_V4.dll";
#endif
#if CSV3
        const string CapStoneNativeMod = "capstone_V3.dll";
#endif
#endif
...
#region P/INVOKE signatures
        ...
        public static extern cs_err cs_option(
            ...
            int type,
            int value);
        [DllImport(CapStoneNativeMod, CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        public static extern string cs_group_name(
            IntPtr handle,
            uint reg_id);
        [DllImport(CapStoneNativeMod, CallingConvention = CallingConvention.Cdecl)]
